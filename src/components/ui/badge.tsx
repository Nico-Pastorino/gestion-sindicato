...
const BENEFIT_TYPE_MAP: Record<BenefitType, { label: string; className: string }> = {
  ...
  supermercado:    { label: "Supermercado",    className: "bg-teal-50 text-teal-700 ring-1 ring-inset ring-teal-600/20 inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium" },
